...
if ($_GET['module'] == 'home') {
  ...
  echo '      <h2>'.users."</h2>\n";
  echo '      <div id="sec-menu"><a href="?module=users&action=add&mode=manual">'.add.'</a> - <a href="?module=users&action=list">'.list_action.'</a> - <a href="?module=users&action=sync">'.sync."</a></div>\n";
}
